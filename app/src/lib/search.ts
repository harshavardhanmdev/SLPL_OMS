...
const STOPWORDS = new Set([
  "book", "books", "the", "a", "an", "for", "of", "and", "buy", "best",
  "material", "materials", "textbook", "textbooks", "study", "learning",
]);
...
const SYNONYMS: Record<string, string[]> = {
  ...
  kids: ["pre-primary", "baby steps"],
  primary: ["primary", "little leaps"],
  highschool: ["high school", "skill builders"],
  secondary: ["high school", "skill builders"],
  ssc: ["grade 10", "skill builders"],
  upsc: ["upsc", "skill builders", "civils"],
  civils: ["upsc", "skill builders"],
  civil: ["upsc", "civils"],
  ias: ["upsc", "civils"],
  aspirant: ["upsc", "civils"],
  gk: ["general knowledge"],
  maths: ["math"],
  math: ["math", "maths"],
  mathematics: ["math", "maths"],
  arithmetic: ["math", "maths"],
  evs: ["evs", "environmental"],
  environment: ["evs", "environmental"],
  science: ["science", "evs"],
  physics: ["science"],
  chemistry: ["science"],
  biology: ["science"],
  social: ["social", "geography", "history"],
  sst: ["social", "geography", "history"],
  geography: ["geography", "social"],
  history: ["history", "social"],
  civics: ["social"],
  grammar: ["english", "grammar"],
  language: ["english", "telugu", "hindi"],
  writing: ["cursive", "handwriting", "writing"],
  cursive: ["cursive", "handwriting"],
  handwriting: ["cursive", "handwriting", "writing"],
  drawing: ["drawing", "coloring"],
  colouring: ["coloring", "drawing"],
  coloring: ["coloring", "drawing"],
  art: ["drawing", "coloring"],
  craft: ["drawing", "coloring"],
  rhymes: ["rhymes", "pre-primary"],
  magazine: ["genz times", "magazine"],
  genz: ["genz times", "magazine"],
  gen: ["genz times"],
  issue: ["genz times", "issue"],
  monthly: ["genz times", "magazine"],
  youth: ["genz times", "magazine"],
  novel: ["novel", "life of student"],
  story: ["novel", "life of student"],
  fiction: ["novel"],
  poem: ["poems"],
  poems: ["poems"],
  poetry: ["poems"],
  ...
  set: ["kit", "bundle"],
  combo: ["kit", "bundle"],
  workbook: ["work book", "workbook"],
  coursebook: ["course book"],
  state: ["telangana", "syllabus"],
  syllabus: ["syllabus", "telangana"],
};
